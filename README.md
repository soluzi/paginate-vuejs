...
![Basic pagination](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/basic-pagination.png)

### Outlined pagination

![Outlined pagination](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/outlined-pagination.png)

### Rounded pagination

![Rounded pagination](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/rounded-pagination.png)

### Show buttons

You can optionally enable first-page and last-page buttons.

![Show buttons](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/show-buttons.png)

### Hide buttons

You can optionally disable the previous-page and next-page buttons.

![Hide buttons](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/hide-buttons.png)

### Custom icons

It's possible to customize the control icons.

![Custom icons](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/custom-icons.png)
...
![Pagination ranges](https://raw.githubusercontent.com/Uniflapp/paginate-vuejs/main/imgs/pagination-ranges.png)
...
| disablePagination | `bool`                                        | `false`    | Toggle the buttons for the entire component on/off.|
| paginationTypes   | `'normal' \| 'standard' \| 'minimal' \| 'of'` | `normal`    | The style of pagination to be applied ('normal', 'standard', 'minimal', or 'of').|
